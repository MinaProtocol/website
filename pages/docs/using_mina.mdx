...
export default Page({ title: "Using Mina" });

# How to use Mina

In this section, we'll give a brief overview on how to use the Mina client and how to get started with interacting with the blockchain.
...
Once you feel comfortable with the basics of creating an address, and sending & receiving mina, we can move on to the truly unique parts of the Mina network - [participating in consensus and helping compress the blockchain](/docs/staking).
