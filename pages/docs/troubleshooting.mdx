...
* Run as a systemd service (see [the docs](/docs/using_mina/connecting#ubuntu-1804--debian-9-1)).
* Run with Docker (see [the docs](/docs/using_mina/connecting#docker)).
...
The methods to start a node [in the documentation](/docs/using_mina/connecting) will run a block producer by default.
