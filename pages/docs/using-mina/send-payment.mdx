...
Run the following command to import your [previously generated](/docs/using_mina/keypair) keypair file:
...
Once you feel comfortable with the basics of creating an address, and sending & receiving mina, we can move on to the truly unique parts of the Mina network - [participating in consensus and helping compress the blockchain](/docs/using_mina/staking).
