...
See our [client SDK documentation](/docs/using_mina/keypair#client-sdk) for more information.
...
Now that we have created our keypair, we can finally [connect to the network](/docs/using_mina/connecting) or share your public key.
