...
You can download all the software required to run a Mina node [here](/docs/getting-started#installation). Right now, we have builds that work on macOS, as well as Debian 9 and Ubuntu 18.04. You can also [build from source](https://github.com/minaprotocol/mina) or run via [Docker](/docs/using_mina/connecting#docker) for other unsupported systems.
...
[See here](/docs/using_mina/connecting#ubuntu-1804--debian-9-1) for information about using launchd or systemd with mina.
