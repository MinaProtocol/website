...
<picture>
  <source media="(min-width:48rem)" srcset="/static/img/docsImages/Documents_FAQFork_Tablet 1.png"/>
  <source media="(min-width:90rem)" srcset="/static/img/docsImages/Documents_SNARKS_p3-01 1.jpg"  width="848"/>
  <img src="/static/img/docsImages/Documents_FAQFork_Mobile 1.png" alt="Snark Workers"></img>
</picture>
