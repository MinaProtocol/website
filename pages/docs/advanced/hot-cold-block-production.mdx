...
See our documentation page on [generating keys](/docs/using_mina/keypair). Note that as this is a hot wallet, you should not use the ledger or any other HSM for this keypair.
...
See our documentation page on [generating keys](/docs/using_mina/keypair). Note that as this is a cold wallet, you should prefer using the most secure mechanism for generating keys as you can preferably on a machine disconnected from the internet.
...
Follow the "Start up a node" instructions in the [Connecting to the Network](/docs/using_mina/connecting) page using your hot wallet key.
