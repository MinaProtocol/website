...
Download the macOS version [here](https://storage.googleapis.com/mina-snapp-credit-app-packages/snapp-credit-check-mac.dmg). Before installing on your Mac, you'll need to install the following dependencies:
